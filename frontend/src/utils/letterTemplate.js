const LETTERHEAD_HEADER_SRC = '/letterhead/header.png';
const LETTERHEAD_FOOTER_SRC = '/letterhead/footer.png';
...
/**
 * Wrap letter body HTML with the Country Lion branded letterhead (header + footer).
 */
export function wrapWithLetterhead({
  title = 'Letter',
  bodyHtml = '',
  extraStyles = '',
  addresseeName = '',
  headerSrc = resolveAssetUrl(LETTERHEAD_HEADER_SRC),
  footerSrc = resolveAssetUrl(LETTERHEAD_FOOTER_SRC),
}) {
